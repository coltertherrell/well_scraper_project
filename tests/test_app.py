...
def temp_files():
    ...
    # Create temp DB file path safely
...
def test_run_single_thread(mock_scraper_class, mock_db_class, temp_files):
    ...
    mock_scraper.scrape_api.return_value = {"API": "30-015-25325", "Operator": "Test"}
...
def test_run_with_errors(mock_scraper_class, mock_db_class, temp_files):
    ...
    mock_scraper = MagicMock()
    mock_scraper.scrape_api.side_effect = [{"API": "30-015-25325", "Operator": "Test"}, None]
    mock_scraper_class.return_value = mock_scraper
    ...
    assert app.errors == 1
    mock_db.insert.assert_called_once_with({"API": "30-015-25325", "Operator": "Test"})
...
def test_csv_with_missing_api(temp_files):
    ...
    # Overwrite CSV with missing API
    ...
    with patch("well_scraper.app.WellScraper") as mock_scraper_class, \
        ...
        assert app.errors == 0
        mock_scraper.scrape_api.assert_not_called()
